...
@parametrize(
    ...
    [
        ...
        ("나는 유리를 먹을 수 있어요. 그래도 아프지 않아요", "나는유리를먹을수있어요그래도아프지않아요"),
...
@parametrize(
    ...
    [
        ...
        ("나는 유리를 먹을 수 있어요. 그래도 아프지 않아요", "나는-유리를-먹을-수-있어요-그래도-아프지-않아요"),
...
@parametrize(
    ...
    [
        ...
        ("나는 유리를 먹을 수 있어요. 그래도 아프지 않아요", "나는_유리를_먹을_수_있어요_그래도_아프지_않아요"),
