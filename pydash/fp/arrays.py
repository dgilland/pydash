...
difference_by = convert([1, 2, 0], pyd.difference_by, cap=True)
difference_with = convert([1, 2, 0], pyd.difference_with, cap=True)
...
intersection_by = convert([1, 2, 0], pyd.intersection_by, cap=True)
intersection_with = convert([1, 2, 0], pyd.intersection_with, cap=True)
...
union_by = convert([1, 2, 0], pyd.union_by, cap=True)
union_with = convert([1, 2, 0], pyd.union_with, cap=True)
uniq = pyd.uniq
...
xor_by = convert([1, 2, 0], pyd.xor_by, cap=True)
xor_with = convert([1, 2, 0], pyd.xor_with, cap=True)
zip_ = convert([0, 1], pyd.zip_)
zip_object = convert([0, 1], pyd.zip_object)
zip_object_deep = convert([0, 1], pyd.zip_object_deep)
zip_with = convert([1, 2, 0], pyd.zip_with, cap=True)
